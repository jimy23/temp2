...
<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
        <li>
            <a href="{{route('admin.profile')}}"><i class="fa fa-fw fa-desktop fa-lg" aria-hidden="true"></i> ESCRITORIO</a>
        </li>
        <li>
            <a href="{{route('admin.institutions.index')}}"><i class="fa fa-fw fa-university fa-lg" aria-hidden="true"></i> INSTITUCIONES</a>
        </li>
        <li>
            <a href="{{route('admin.groups.index')}}"><i class="fa fa-fw fa-users fa-lg" aria-hidden="true"></i> GRUPOS</a>
        </li>
        <li>
        ...
        <li>
            <a href="{{route('admin.solicitudes.index')}}"><i class="fa fa-fw fa-check-square-o fa-lg" aria-hidden="true"></i> SOLICITUDES</a>
        </li>
