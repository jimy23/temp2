...
@section('content')
    ...
    <p>
        <a class="btn btn-primary" href="{{route('admin.users.create')}}">Añadir usuarios</a>
    </p>
    <div class="row">
                ...
                <table class="table table-bordered table-hover table-striped results">
                    ...
                    @foreach($users as $usuario)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.users.edit',$usuario->id) }}" class="btn btn-primary"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span></a>
                                <a href="{{ route('admin.users.destroy',$usuario->id) }}" onclick="return confirm('¿Seguro que deseas eliminarlo?')" class="btn btn-danger"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
