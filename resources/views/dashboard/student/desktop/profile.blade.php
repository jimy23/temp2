            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <div style="text-align: center;"> <i class="fa fa-fw fa-user fa-1g"></i>Perfil Estudiante </div>
                    </h1>
                </div>
            </div>
<!-- /.row -->

{!! Form::open(['route'=>['student.profile.update',Auth::user()], 'method' => 'PUT', 'class'=>'form-horizontal']) !!}
